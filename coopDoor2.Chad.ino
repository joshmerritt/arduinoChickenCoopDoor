...
int BRIGHTNESS = 100;
int morningLightLevel = 100;
int nightLightLevel = 500;
...
int runCount = 0;
int timeOut = 250;
int countTopSwitchOpen = 0;
int countBottomSwitchOpen = 0;
int openAttempts = 0;
int closeAttempts = 0;
int readLightLevelDelay = 15000;
    ...
    if(door("Open") && readingsExceed(nightLightLevel)) {
        ...
        if(door("Open") && readingsExceed(nightLightLevel)) {
            ...
            while(bottomSwitch == 1) {
                ...
                if(runCount > timeOut || countTopSwitchOpen > 10) break;
            }
            allOff();
            updateLED();
            if(bottomSwitch == 0) {
...
void checkAttempts() {
   if(openAttempts > 2 || closeAttempts > 2) {
